...
const MO_SEED = [
  {
    ...
    brandstof: "Benzine", transmissie: "Handgeschakeld", kleur: "Grijs metallic",
    ...
    fotos: [], status: "te-koop", createdAt: "2026-06-01"
  },
  {
    id: "bmw-3-2018",
    kenteken: "TP-456-D",
    ...
    brandstof: "Benzine", transmissie: "Automaat", kleur: "Zwart metallic",
    ...
    fotos: [], status: "te-koop", createdAt: "2026-06-08"
  },
  {
    id: "audi-a3-2020",
    kenteken: "GH-221-N",
    ...
    fotos: [], status: "te-koop", createdAt: "2026-06-12"
  },
  {
    ...
    brandstof: "Hybride", transmissie: "Automaat", kleur: "Rood",
    ...
    fotos: [], status: "te-koop", createdAt: "2026-06-15"
  },
  {
    id: "mercedes-a-2019",
    kenteken: "XN-777-B",
    ...
    fotos: [], status: "gereserveerd", createdAt: "2026-06-18"
  },
  {
    id: "kia-picanto-2022",
    kenteken: "PZ-104-T",
    ...
    brandstof: "Benzine", transmissie: "Handgeschakeld", kleur: "Blauw",
    ...
    fotos: [], status: "te-koop", createdAt: "2026-06-22"
  }
];
...
function moInitStore() {
  try {
    if (!localStorage.getItem(MO_STORE_KEY)) moSaveCars(MO_SEED);
    ...
    '<article class="car-card reveal">' +
      '<a href="/occasion.html?id=' + encodeURIComponent(car.id) + '" aria-label="Bekijk ' + moEsc(car.merk + " " + car.model) + '">' +
        '<div class="car-media">' +
          ...
          '<img src="' + moMainPhoto(car) + '" alt="' + moEsc(car.merk + " " + car.model + " " + car.uitvoering + " " + car.bouwjaar) + '" loading="lazy" width="800" height="540">' +
      ...
      '<div class="car-body">' +
        ...
        "</div>" +
        '<div class="car-foot">' +
          '<div class="car-price">' + moEuro(car.prijs) + "<small>incl. rijklaar maken</small></div>" +
