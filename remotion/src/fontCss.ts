// Auto-gegenereerd vanaf Google Fonts (Anton, Inter, Outfit, Instrument Serif),
// lokaal opgeslagen in public/fonts. Alleen de latin-subsets.
export const FONT_CSS = `/* latin-ext */
@font-face {
  font-family: 'Anton';
  font-style: normal;
  font-weight: 400;
